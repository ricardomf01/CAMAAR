...
Funcionalidade: Criar template de formulário
    ...
    Cenário: Criar um template com sucesso (Cenário Feliz)
        ...
        Quando preencho o campo "Nome do Template" com "Avaliação Docente Padrão"
    ...
    @cenario_triste
    Cenário: Tentar criar um template sem título (Cenário Triste 1)
        Dado que estou na página de criação de templates
        Quando preencho o campo "Nome do Template" com ""
    ...
    @cenario_triste
    Cenário: Tentar criar um template sem perguntas (Cenário Triste 2)
        Dado que estou na página de criação de templates
        Quando preencho o campo "Nome do Template" com "Avaliação Docente Padrão"
        E clico em "Salvar Template"
